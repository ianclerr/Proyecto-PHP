...
<head>
    ...
    <title>Confirmar Instalacion</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <table>
            ...
            if (!empty($_POST['estado'])) {
                ...
                echo $query = "UPDATE solicitud SET sol_estado=2, sol_horaaprobada = '$nuevaFecha', sol_fechaaprobada ='$fechaActual' WHERE sol_codigo=$reservaCodigo";
                mysqli_query($conexion, $query);
            }   
            $query = "SELECT * FROM solicitud WHERE sol_estado = 1";
            ...
            while ($row = mysqli_fetch_array($res)) {
                ...
                echo "<form action='reg_instalacion.php' method='POST'>";
                
                echo "<input type='hidden' name='codigo' value='" . $row["sol_codigo"] . "'>";
                echo "<input type='submit' value='Con' name='estado'>";
